...
with tab1:
    ...
    with col_b:
        ...
        surv_12 = float(subset_12.iloc[-1]) if len(subset_12) > 0 else None
        subset_24 = kmf.survival_function_[kmf.survival_function_.index <= 24]
        surv_24 = float(subset_24.iloc[-1]) if len(subset_24) > 0 else None
        subset_36 = kmf.survival_function_[kmf.survival_function_.index <= 36]
        surv_36 = float(subset_36.iloc[-1]) if len(subset_36) > 0 else None
